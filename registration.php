                ...
                <h1>Register</h1>
                    <form role="form" action="registration.php" method="post" id="login-form" autocomplete="off">
                        <div class="form-group">
                            ...
                            <h4 class="bg-danger text-danger"><?php echo isset($error['username']) ? $error['username'] : '';  ?></h4>
                         ...
                         <div class="form-group">
                            ...
                            <h4 class="bg-danger text-danger"><?php echo isset($error['email']) ? $error['email'] : '';  ?></h4>
                         ...
                         <div class="form-group">
                            ...
                            <h4 class="bg-danger text-danger"><?php echo isset($error['password']) ? $error['password'] : '';  ?></h4>
